...
function getArtistByIndex(arr, i) {
  console.log(`The artist at index ${[i]} is ${arr[i].name}.`);
  }
...
function get20s(arr){
  ...
  for (let i = 0; i < arr.length; i++){
    let bornDied = Number(arr[i].years.slice(0,4));
    if (bornDied >= 1900 && bornDied <= 2000){
...
console.log(randomize(artistsRandom));
